...
from lerobot.teleoperators.xlerobot_yaw_gamepad import *
...
def main(cfg: RecordConfig):
    ...
    logger.info("\n" + pformat(asdict(cfg)))
    if cfg.display_data:
        init_rerun(session_name="xlerobot_yaw_teleop_gamepad", ip=cfg.display_ip, port=cfg.display_port)
    ...
    teleop = XLeRobotYawGamepad(cfg.teleop, PS5Gamepad(id=0))
        ...
        with VideoEncodingManager(dataset):
            ...
            while episode_idx < NUM_EPISODES and not events["stop_recording"] and not events["exit_teleop"]:
                ...
                record_loop(
                    ...
                    teleop_action_processor=gamepad_to_robot_joints_processor,
